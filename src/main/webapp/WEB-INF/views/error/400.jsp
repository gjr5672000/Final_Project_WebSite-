...
<head>
    ...
    <title>Error 400 | Nifty - Admin Template</title>
            ...
            <div class="content__boxed card rounded-0 w-100 min-vh-100 d-flex flex-column align-items-stretch justify-content-center">
                <div class="content__wrap">
                    ...
                    <div class="text-center">
                        <div class="error-code page-title mb-3">400</div>
                        <h3 class="mb-4">
                            <div class="badge bg-info">Bad Request!</div>
                        </h3>
                        <p class="lead">잘못된 요청입니다. 다시 요청해주세요.</p>
                    </div>
