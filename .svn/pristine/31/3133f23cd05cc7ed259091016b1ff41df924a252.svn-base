...
<head>
    ...
    <title>Error 415 | Nifty - Admin Template</title>
            ...
            <div class="content__boxed card rounded-0 w-100 min-vh-100 d-flex flex-column align-items-stretch justify-content-center">
                <div class="content__wrap">
                    ...
                    <div class="text-center">
                        <div class="error-code page-title mb-3">415</div>
                        <h3 class="mb-4">
                            <div class="badge bg-info">Unsupported Media Type!</div>
                        </h3>
                        <p class="lead">지원하지 않는 형식입니다.</p>
                    </div>

                    <!-- Search form -->
                    <div class="col-md-8 offset-md-2 py-4">
                        <form class="searchbox input-group">
                            <input class="searchbox__input form-control form-control-lg" type="search" placeholder="Type for search . . ." aria-label="Search">
                            <div class="searchbox__btn-group">
                                <button class="searchbox__btn btn btn-icon shadow-none border-0 btn-sm" type="submit">
                    ...
                    <div class="d-flex justify-content-center gap-3 mt-4">
                        ...
                        <a href="${cPath }/index.do" class="btn btn-primary">Return home</a>
                    </div>
                    <!-- END : Action buttons -->
        ...
        <footer class="footer content__wrap border-top">
            <div class="row mt-4">
                <div class="col-12 col-sm-6 col-lg-4 mb-4">
                    ...
                    <p><strong class="h5">Nifty</strong> is is flat admin template for multi-purpose usage built with the latest version of Bootstrap.</p>
                    <p class="mb-0">Made with<i class="demo-psi-heart-2 fs-4 text-danger mx-1"></i>by <a class="ml-1 fw-semibold btn-link" href="https://themeon.net/">ThemeOn</a></p>
