...
<head>
    ...
    <title>Error 403 | Nifty - Admin Template</title>
            ...
            <div class="content__boxed card rounded-0 w-100 min-vh-100 d-flex flex-column align-items-stretch justify-content-center">
                <div class="content__wrap">
                    ...
                    <div class="text-center">
                        <div class="error-code page-title mb-3">403</div>
                        <h3 class="mb-4">
                            <div class="badge bg-warning">Forbidden</div>
                        </h3>
                        <p class="lead">접근할 수 있는 권한이 없습니다.</p>
                    </div>
